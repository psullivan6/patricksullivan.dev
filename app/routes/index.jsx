  ...
  return (
    <>
      ...
      <main className="flex flex-col lg:flex-row">
        <section className="flex flex-col justify-center items-center w-full lg:w-[38.197097%] h-[38.197097%] lg:h-full shrink-0 relative">
          <div className="relative w-56 h-56 z-0">
            <svg
              ...
              className="z-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ml-2 w-12 fill-slate-800"
            >
        ...
        <section className="flex flex-col justify-center items-center w-full lg:w-full h-full bg-sky-400 dark:bg-zinc-800 p-16 md:p-28 xl:p-32 2xl:p-40 transition-all">
          <div>
            <span className="block font-mono font-thin text-base leading-8 tracking-widest">
              Hey, I&rsquo;m
            </span>
            <h1 className="text-6xl z-10 mb-12">
              <span className="block font-thicc uppercase">
                Patrick Sullivan
              </span>
            </h1>
            <p className="font-mono leading-8 tracking-widest mb-4">
              a front-end focused engineer passionate about building engaging
              experiences and thriving teams.
            </p>
            <p className="font-mono leading-8 tracking-widest">
              My work includes interactive sites and applications for Jack in
              the Box, undisclosed Winston-Salem brand, Lowe's, and many more. I
              started my career on the West coast and proudly support my alma
              mater, the Oregon Ducks and my always-close-to-Super-Bowl-bound
              49ers.
            </p>
          </div>
        </section>
