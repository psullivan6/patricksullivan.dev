    ...
    <>
      ...
      >
        ...
        >
          ...
          <article className="overflow-hidden relative flex flex-wrap justify-center items-center w-full h-[38.197097%] shrink-0 bg-green-400 transition-all font-mono text-center leading-loose">
            <ul>
              <li>
                <a href="https://twitter.com/psullivan6" target="_blank" rel="noreferrer">
                  Twitter
                </a>
              </li>
              <li>
                <a href="mailto:psullivan6@gmail.com" target="_blank" rel="noreferrer">
                  Email
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/in/psullivan6/" target="_blank" rel="noreferrer">
                  LinkedIn
                </a>
              </li>
            </ul>
        ...
        <section
          className={`relative flex flex-col justify-center items-center shrink-0 w-full lg:w-[61.802903%] h-full bg-blue dark:bg-zinc-800 p-16 md:p-28 xl:p-32 2xl:p-40 transition-all duration-500`}
          data-themed
        >
          <div>
